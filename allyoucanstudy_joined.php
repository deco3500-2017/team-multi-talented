...
if(isset($_POST['submit'])){
    ...
    $message = $name . " " . "(" . $email . ")" . " ticket detail:<br><br>" 
        ...
        . "\n\n" . "Event Name: " . "<b>" . "All You Can Study" . "</b><br>"
        . "\n\n" . "Event Host: " . "<b>" .  "UQU</b><br>"
        . "\n\n" . "Event Details: " . "<b>" .  "Welcome to the AllYouCanStudy Event channel, where study and meet up happen.</b><br>"
        . "\n\n" . "Event Location: " . "<b>" .  "Forgan Smith Building, St Lucia</b><br>"
...
<head>
    ...
    <title>AllYouCanStudy Event Channel</title>
...
<body>
    ...
    <header id="page-header">
        <nav>
            <div class="left">
                <a href="arialHome.html" class="brand"><img src="img/cclogo.png" width="35" height="35">  CultureConnect</a>
            </div>
            <!--end left-->
            <div class="right">
                <div class="primary-nav has-mega-menu">
                    <ul class="navigation">
                        <li><a href="arialHomeAYCS.html">Home</a></li>
                        ...
                        <li class="has-child"><a class="promoted">My Events</a>
                            <div class="wrapper">
                                <div id="nav-homepages" class="nav-wrapper">
                                    <ul>
                                        <li>
                                            <a href="photographyarialAYCS_joined.html">Photography</a>
                                        </li>
                                        <li>
                                            <a href="csse3002arialAYCS_joined.html">CSSE3002</a>
                                        </li>
                                        <li>
                                            <a href="kabukiarialAYCS_joined.html">Kabuki</a>
                                        </li>
                                        <li>
                                            <a class="promoted">All You Can Study</a>
                                        </li>
                        ...
                        <div class="card">
                            <div class="card-header" role="tab" id="headingOne-1">
                                <h6 class="mb-0">
									...
									<br><center><img src="img/csse3002new.png" alt="photo"><br><br>
										AllYouCanStudy<br>
										The True Study Event</center> 
                            ...
                            <div id="collapseOne-1" class="collapse show" role="tabpanel" aria-labelledby="headingOne">
                                <ul class="your-profile-menu">
                                    <li>
                                        <center>
                                            Welcome to the AllYouCanStudy Event channel, where study and fun happen.
                                        </center>
                                    </li>
                            ...
                            <div class="card">
                                <div class="card-header" role="tab" id="headingOne">
                                    ...
                                    <h6 class="mb-0">
										...
										<br><center><img src="img/csse3002new.png" alt="photo"><br><br>
										AllYouCanStudy<br>
										The True Study Event<br><br></center>
										<svg class="olymp-dropdown-arrow-icon"><use xlink:href="icons/icons.svg#olymp-dropdown-arrow-icon"></use></svg>
									</a>
                                    </h6>
                        ...
                        <input type="button" name="submit" class="form-control submit" value="Maybe Later">
                                ...
                                <div id="collapseOne" class="collapse show" role="tabpanel" aria-labelledby="headingOne">
                                    <ul class="your-profile-menu">
                                        <li>
                                            <center>
                                                Welcome to the AllYouCanStudy Event channel, where work and other discussions happen.
                                            </center>
                                        </li>
                                        <br>
                                    </ul>
