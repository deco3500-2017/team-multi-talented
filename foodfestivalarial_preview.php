...
if(isset($_POST['submit'])){
    ...
    $message = $name . " " . "(" . $email . ")" . " ticket detail:<br><br>" 
        ...
        . "\n\n" . "Event Name: " . "<b>" . "German Food Festival" . "</b><br>"
        . "\n\n" . "Event Host: " . "<b>" .  "The Federal Republic of Germany, Brisbane</b><br>"
        . "\n\n" . "Event Details: " . "<b>" .  "An annual festival in Brisbane celebrating authentic German food! Tingle your taste buds, seat back, relax and enjoy.  </b><br>"
        . "\n\n" . "Event Location: " . "<b>" .  "71 Munroe Street</b><br>"
        . "\n\n" . "Event Date: " . "<b>" .  "Saturday, November 11th 2017 | 5.30 PM - 8.30 PM</b><br>"
...
<head>
    ...
    <title>German Food Festival</title>
            ...
            <div class="ui-block">
                <div class="your-profile">
                    <div class="ui-block-title ui-block-title-small">
                        <h2 class="title">Event - Food Festival</h2>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-header" role="tab" id="headingOne-1">
                                <h6 class="mb-0">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
										<br><center>
										<img src="assets/img/items/46.jpg" width="160" height="100"><br><br>
										German Food Festival</center>
                            ...
                            <div id="collapseOne" class="collapse show" role="tabpanel" aria-labelledby="headingOne">
                                <ul class="your-profile-menu">
                                    <li>
                                        <B>About:</b> An annual festival in Brisbane celebrating authentic German food! Tingle your taste buds, seat back, relax and enjoy.
                                        <br><br>
                                    </li>
                                    <li>
                                        <B>Location:</b> 71 Munroe Street
                                        <br><br>
                                    </li>
                                    <li>
                                        <b>Date:</b> 15.11.2017<br><br>
                                        <b>Time:</b> 4.00 pm - late<br><br>
                                    ...
                                    <br>
                                    <center>
                                        <a href="foodfestivalarial_joined.html" class="btn btn-breez btn-sm">Join Channel</a>
                                    </center>
                                </ul>
                            </div>
                        </div>
        ...
        <div class="row">
                            ...
                            <div class="chat-field">
                                    ...
                                    <ul class="notification-list chat-message chat-message-field">
                                        ...
                                        <li>
                                            ...
                                            <div class="notification-event">
                                                ...
                                                <span class="chat-message-item">Hi Ed! We're meeting at 3.45 pm at 11 Ebor St, Toowong. Hope to see you there!:
										</span>
                                ...
                                <form>
                                    ...
                                    <div class="form-group label-floating is-empty">
                                        <center>
                                            <a href="foodfestivalarial_joined.html" class="btn btn-breez btn-sm">Join Channel</a><br>
                                        </center>
            ...
            <div class="col-xl-3 order-xl-1 col-lg-3 order-lg-1 col-md-12 order-md-2 col-sm-12 col-xs-12 responsive-display-none">
                <div class="ui-block">
                    <div class="your-profile">
                        <div class="ui-block-title ui-block-title-small">
                            <h1 class="title">Event - Food Festival</h1>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-header" role="tab" id="headingOne">
                                    ...
                                    <h6 class="mb-0">
										...
										<br><center>
										<img src="assets/img/items/46.jpg" width="160" height="100"><br><br>
										German Food Festival<br><br></center>
										<svg class="olymp-dropdown-arrow-icon"><use xlink:href="icons/icons.svg#olymp-dropdown-arrow-icon"></use></svg>
									</a>
                                    </h6>
                        ...
                        <input type="button" name="submit" class="form-control submit" value="Maybe Later">
                                ...
                                <div id="collapseOne" class="collapse show" role="tabpanel" aria-labelledby="headingOne">
                                    <ul class="your-profile-menu">
                                        ...
                                        <br>
                                        <center>
                                            <a href="foodfestivalarial_joined.php" class="btn btn-breez btn-sm">Join Channel</a>
                                        </center>
                                    </ul>
