...
<head>
	...
	<title>Indonesian Acoustic Music Night</title>
		...
		<div class="ui-block">
			<div class="your-profile">
				<div class="ui-block-title ui-block-title-small">
					<h2 class="title">CULTURAL MUSIC</h2>
				</div>
						...
						<div class="card-header" role="tab" id="headingOne-1">
							...
							<div id="collapseOne" class="collapse show" role="tabpanel" aria-labelledby="headingOne">
								<ul class="your-profile-menu">
									...
									<li>
										<b>Location:</b> Sonny's House, Brisbane<br><br>
										<center>
									...
									<li>
										<b>Attendees:</b><br>
										<center>
										<img src="img/members.jpg" width="100" height="35" alt="members">
										</center>
									</li>
		...
		<div class="col-xl-9 order-xl-2 col-lg-9 order-lg-2 col-md-12 order-md-1 col-sm-12 col-xs-12">
			<div class="ui-block">
				<div class="ui-block-title">
					<h6 class="title">Indonesian Acoustic Music Night</h6>
						...
						<ul class="notification-list chat-message">
							<li class="chat-group">
								<div class="notification-event">
									...
									Live Indonesian acoustic music at the heart of Brisbane,
											featuring a famous Indonesian band, Radja - coming to you all the way from
											Jakarta!
									<br><br>
							...
							<div class="mCustomScrollbar" data-mcs-theme="dark">
								<ul class="notification-list chat-message chat-message-field">
									<li>
										...
										<div class="notification-event">
											<a href="#" class="h6 notification-friend">Winn Scott</a>
											<span class="notification-date"><time class="entry-date updated" datetime="2004-07-24T18:18">Yesterday at 8:10am</time></span>
											<span class="chat-message-item">John is a such an amazing host! Super friendly, helpful and insightful. 
									</span>
										</div>
									</li>
									...
									<li>
										...
										<span class="chat-message-item">My friends and I love Indonesian music - we joined this event last month and we're joining again this time around! 
