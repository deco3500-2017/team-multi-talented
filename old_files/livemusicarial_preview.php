...
if(isset($_POST['submit'])){
    $to = $_POST['email'];
    $from = "cultureconnect@uqcloud.net";
    $name = $_POST['name'];
    $email = $_POST['email'];
    $subject = "E-invitation from CultureConnect for " . $name . " (" . $email . ")";
    $message = $name . " " . "(" . $email . ")" . " this is your ticket detail :<br>" 
		. "\n\n" . "Name: " . "<b>" . $name . "</b><br>"
		. "\n\n" . "E-mail: " . "<b>" . $email . "</b><br>"
		. "\n\n" . "Event Name : " . "<strong>" . $event . "</strong><br>"
		. "\n\n" . "<b>About :</b>" .  "Indonesian Acoustic Music Night" . "<br>"
		. "\n\n" . "Discharged from bankruptcy or debt agreement in the last 10 years? " . "<b>" .  $_POST['optradio2'] . "</b><br>"
		. "\n\n" . "How much money do you owe - roughly? " . "<b>" .  $_POST['owed'] . "</b><br>"
		. "\n\n" . "How many creditors do you have? " .  "<b>" . $_POST['creditors'] . "</b><br>"
		. "\n\n" . "Do you rent or own your own home? " .  "<b>" . $_POST['optradio3'] . "</b><br>"
		. "\n\n" . "Which one of the following best describes you? " . "<b>" . $_POST['optradio4'] . "</b><br>"
		. "\n\n" . "What is the best time to contact you? " . "<b>" . $_POST['pref'] . "</b><br>";

	$headers = "Content-Type: text/html; charset=ISO-8859-1\r\n" . "From:" . $name . '<' . $from . '>';
    $headers2 = "From: CultureConnect <cultureconnect@uqcloud.net>";
                            ...
                            <div class="chat-field">
                                ...
                                <form>
                                    ...
                                    <div class="form-group label-floating is-empty">
                                        <center>
                                            <a href="livemusicarial_joined.html" class="btn btn-breez btn-sm">Join Channel</a><br>
                                        </center>
