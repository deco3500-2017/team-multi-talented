        ...
        <nav style="position: fixed">
            ...
            <div class="right">
                <div class="primary-nav has-mega-menu">
                    <ul class="navigation">
                        <li><a href="arialHomeMV.html">Home</a></li>
                        ...
                        <li class="has-child"><a>My Profile</a>
                            <div class="wrapper">
                                <div id="nav-homepages" class="nav-wrapper">
                                    <ul>
                                        <li><a href="arialProfileMV.html">Personal Info</a></li>
                                        <li><a href="arialAccountsettingsMV.html">Account setting</a></li>
                                        <li><a href="arialChangepasswordMV.html">Change Password</a></li>
                                    </ul>
                                </div>
                            </div>
                        </li>
                        ...
                        <li class="has-child"><a class="promoted">My Events</a>
                            <div class="wrapper">
                                <div id="nav-homepages" class="nav-wrapper">
                                    <ul>
                                        <li>
                                            <a href="photographyarialMV_joined.html">Photography</a>
                                        </li>
                                        <li>
                                            <a href="csse3002arialMV_joined.html">CSSE3002</a>
                                        </li>
                                        <li>
                                            <a href="kabukiarialMV_joined.html">Kabuki</a>
                                        </li>
                                        <li>
                                            <a class="promoted">Inner Market Visist</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
