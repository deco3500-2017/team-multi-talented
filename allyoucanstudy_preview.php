...
<head>
    ...
    <title>All You Can Study Event</title>
                        ...
                        <div class="card ">
                            <div class="card-header " role="tab " id="headingOne-1 ">
                                <h6 class="mb-0 ">
									...
									<br><center><img src="/assets/img/allyoucanstudy.jpg " alt="photo "><br><br>
										AllYouCanStudy<br>
                            ...
                            <div id="collapseOne-1 " class="collapse show " role="tabpanel " aria-labelledby="headingOne ">
                                <ul class="your-profile-menu ">
                                    ...
                                    <br>
                                    <center>
                                        <a href="allyoucanstudy_joined.php" class="btn btn-breez btn-sm ">Join Channel</a>
                                    </center>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="chat-field ">
                                ...
                                <form>
                                    ...
                                    <div class="form-group label-floating is-empty ">
                                        <center>
                                            <a href="allyoucanstudy_joined.php" class="btn btn-breez btn-sm ">Join Channel</a><br>
                                        </center>
                        ...
                        <input type="button" name="submit" class="form-control submit" value="Maybe Later">
                                ...
                                <div id="collapseOne " class="collapse show " role="tabpanel " aria-labelledby="headingOne ">
                                    <ul class="your-profile-menu ">
                                        <li>
                                            <center>
                                                Welcome to the AllYouCanStudy Event channel, where study and meet up happen.
                                            </center>
                                        </li>
                                        <li>
                                            <center><br>
