                        ...
                        <div class="card ">
                            <div class="card-header " role="tab " id="headingOne-1 ">
                                <h6 class="mb-0 ">
                                    <a data-toggle="collapse " data-parent="#accordion " href="#collapseOne " aria-expanded="true " aria-controls="collapseOne ">
										<br><center>
										<img src="img/dancingnight.jpg " width="160 " height="100 "><br><br>
										Dancing Night</center>
                            ...
                            <div id="collapseOne " class="collapse show " role="tabpanel " aria-labelledby="headingOne ">
                                <ul class="your-profile-menu ">
                                    <li>
                                        <b>About:</b> The largset dancing event in UQ, girls only! Lets find out whose the real dancing queen!
                                        <br><br>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        ...
                                        <b>Time:</b> 7.00 pm - 11.00 pm<br><br>
                                    ...
                                    <br>
                                    <center>
                                        <a href="dancingNight_joined.php " class="btn btn-breez btn-sm ">Join Channel</a>
                                    </center>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="chat-field ">
                                ...
                                <form>
                                    ...
                                    <div class="form-group label-floating is-empty ">
                                        <center>
                                            <a href="dancingNight_joined.html" class="btn btn-breez btn-sm ">Join Channel</a><br>
                                        </center>
