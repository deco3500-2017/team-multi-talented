...
if(isset($_POST['submit'])){
    ...
    $message = $name . " " . "(" . $email . ")" . " ticket detail:<br><br>" 
        ...
        . "\n\n" . "Event Name: " . "<b>" . "Diwali: Festival of Lights" . "</b><br>"
        . "\n\n" . "Event Host: " . "<b>" .  "UQU</b><br>"
        . "\n\n" . "Event Details: " . "<b>" .  "Join UQU on the 28th of October from 5:30pm in The Holt Room to celebrate this festive occasion including live performances, interactive stalls, henna tattoos, Rangoli art and a free delicious Indian feast!</b><br>"
        . "\n\n" . "Event Location: " . "<b>" .  "The Holt Room</b><br>"
							...
							<div class="card-header" role="tab" id="headingOne">
								...
								<h6 class="mb-0">
									<a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
										<br><center>
										<img src="assets/img/items/54.jpg" width="160" height="100"><br><br>
										Diwali: Festival of Lights<br><br></center>
										<svg class="olymp-dropdown-arrow-icon"><use xlink:href="icons/icons.svg#olymp-dropdown-arrow-icon"></use></svg>
									</a>
								</h6>
