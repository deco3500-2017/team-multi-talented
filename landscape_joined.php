...
<head>
    ...
    <title>LANDSCAPE CHALLENGE (NIGHT)</title>
        ...
        <nav style="position: fixed">
            ...
            <div class="right">
                <div class="primary-nav has-mega-menu">
                    <ul class="navigation">
                        <li><a href="arialHomeLC.html">Home</a></li>
                        ...
                        <li class="has-child"><a>My Profile</a>
                            <div class="wrapper">
                                <div id="nav-homepages" class="nav-wrapper">
                                    <ul>
                                        <li><a href="arialProfileLC.html">Personal Info</a></li>
                                        <li><a href="arialAccountsettingsLC.html">Account setting</a></li>
                                        <li><a href="arialChangepasswordLC.html">Change Password</a></li>
                                    </ul>
                                </div>
                            </div>
                        </li>
                            ...
                            <div class="wrapper">
                                <div id="nav-homepages" class="nav-wrapper">
                                    <ul>
                                        ...
                                        <li>
                                            <a class="promoted">Landscape Challenge</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
            ...
            <div class="ui-block">
                <div class="your-profile">
                    <div class="ui-block-title ui-block-title-small">
                        <h2 class="title">Events - Landscape Challenge (Night)</h2>
                    </div>
                            ...
                            <div class="card-header" role="tab" id="headingOne-1">
                                <h6 class="mb-0">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
										...
										Landscape Challenge (Night)</center>
        ...
        <div class="row">
            ...
            <div class="col-xl-3 order-xl-1 col-lg-3 order-lg-1 col-md-12 order-md-2 col-sm-12 col-xs-12 responsive-display-none">
                <div class="ui-block">
                    <div class="your-profile">
                        <div class="ui-block-title ui-block-title-small">
                            <h1 class="title">Event - Landscape Challenge (Night)<br><br></h1>
                        </div>
